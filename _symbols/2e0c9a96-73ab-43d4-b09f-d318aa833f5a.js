// Site Navigation German - Updated September 23, 2023
function noop() { }
const identity = x => x;
...
function create_each_block_1(ctx) {
	...
	return {
		...
		h() {
			attr(button, "class", "link svelte-1676l5v");
		},
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = listen(button, "click", scroll);
				mounted = true;
			}
		},
		p(ctx, dirty) {
			if (dirty & /*site_nav*/ 4 && t_value !== (t_value = /*link*/ ctx[10].label + "")) set_data(t, t_value);
		},
		d(detaching) {
...
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			...
			attr(button, "class", "svelte-1676l5v");
			attr(nav, "id", "popup");
			attr(nav, "class", "svelte-1676l5v");
		},
		m(target, anchor) {
...
function create_each_block(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty & /*site_nav*/ 4 && a_href_value !== (a_href_value = /*link*/ ctx[10].url)) {
...
function create_fragment(ctx) {
	...
	let mounted;
	let dispose;
	let if_block0 = /*logo*/ ctx[1].image.url && create_if_block_3(ctx);
	...
	let if_block1 = /*logo*/ ctx[1].image.url && create_if_block_2(ctx);
	...
	return {
		...
		l(nodes) {
			...
			button = claim_element(div4_nodes, "BUTTON", { id: true, "aria-label": true });
			var button_nodes = children(button);
			claim_component(icon.$$.fragment, button_nodes);
			button_nodes.forEach(detach);
		...
		h() {
			attr(a0, "href", "/");
			attr(a0, "class", "logo svelte-1676l5v");
			attr(div0, "class", "nav-list svelte-1676l5v");
			attr(div1, "class", "button-content svelte-1676l5v");
			attr(a1, "href", a1_href_value = /*primary_cta*/ ctx[3].url);
			attr(div2, "class", "custom-button svelte-1676l5v");
			attr(div3, "class", "desktop-nav svelte-1676l5v");
			attr(a2, "href", "/");
			attr(a2, "class", "logo svelte-1676l5v");
			attr(button, "id", "open");
			attr(button, "aria-label", "Open mobile navigation");
			attr(div4, "class", "mobile-nav svelte-1676l5v");
			attr(header, "class", "section-container svelte-1676l5v");
			attr(div5, "class", "section svelte-1676l5v");
		},
		m(target, anchor) {
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('english' in $$props) $$invalidate(6, english = $$props.english);
