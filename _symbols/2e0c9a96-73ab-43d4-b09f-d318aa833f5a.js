...
function create_each_block(ctx) {
	...
	return {
		...
		h() {
			attr(button, "class", "link svelte-1x6pouv");
		},
		m(target, anchor) {
...
function create_fragment(ctx) {
	...
	let t2;
	let a1_href_value;
	let if_block = /*logo*/ ctx[0].image.url && create_if_block(ctx);
	...
	return {
		...
		h() {
			attr(a0, "href", "/");
			attr(a0, "class", "logo svelte-1x6pouv");
			attr(div0, "class", "nav-list svelte-1x6pouv");
			attr(div1, "class", "button-content svelte-1x6pouv");
			attr(a1, "href", a1_href_value = /*primary_cta*/ ctx[2].url);
			attr(div2, "class", "custom-button svelte-1x6pouv");
			attr(div3, "class", "desktop-nav svelte-1x6pouv");
			attr(header, "class", "section-container svelte-1x6pouv");
			attr(div4, "class", "section svelte-1x6pouv");
		},
		m(target, anchor) {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*primary_cta*/ 4 && t2_value !== (t2_value = /*primary_cta*/ ctx[2].label + "")) set_data(t2, t2_value);

			if (dirty & /*primary_cta*/ 4 && a1_href_value !== (a1_href_value = /*primary_cta*/ ctx[2].url)) {
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('english' in $$props) $$invalidate(5, english = $$props.english);
	...
	return [logo, site_nav, primary_cta, props, lang, english];
}
