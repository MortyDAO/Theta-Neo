// Hero with form - Updated September 27, 2023
function noop() { }
const identity = x => x;
...
function create_if_block_5(ctx) {
	...
	return {
		...
		h() {
			attr(div, "class", "message error svelte-1fg2ljo");
		},
		m(target, anchor) {
...
function create_if_block_4(ctx) {
	...
	return {
		...
		h() {
			attr(div, "class", "message svelte-1fg2ljo");
		},
		m(target, anchor) {
			insert_hydration(target, div, anchor);
			append_hydration(div, t);
...
function create_if_block_2(ctx) {
	...
	return {
		...
		h() {
			...
			attr(input, "class", "svelte-1fg2ljo");
			attr(label, "class", "svelte-1fg2ljo");
			attr(button, "class", "button svelte-1fg2ljo");
			attr(button, "type", "submit");
			attr(form_1, "class", "svelte-1fg2ljo");
		},
		m(target, anchor) {
...
function create_if_block_1(ctx) {
	...
	return {
		...
		h() {
			attr(img, "class", "graphic left svelte-1fg2ljo");
...
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			attr(img, "class", "graphic right svelte-1fg2ljo");
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			attr(h1, "class", "headline svelte-1fg2ljo");
			attr(section, "class", "section-container svelte-1fg2ljo");
		},
		m(target, anchor) {
